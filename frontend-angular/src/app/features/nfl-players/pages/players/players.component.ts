...
export class PlayersPage {
  ...
  isLoading = false;
  recommendedSearches = ["Mobile QB with Strong arm", "Efficient pocket passer", "Powerful running back", "Underrated WR with great hands"];
  searchValue = signal("");
  ...
  handleSearch(value: string) {
    ...
    this.playerService.apiV1PlayersSimilaritySearchPost({ search: value }).subscribe({
      next: (players) => {
